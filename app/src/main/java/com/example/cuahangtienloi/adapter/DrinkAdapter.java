...
public class DrinkAdapter extends RecyclerView.Adapter<DrinkAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View item= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_drink, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.tensp.setText(sanPhamMoi.getTenSanpham().trim());
        //lấy cả khoảng trống.
        DecimalFormat decimalFormat = new DecimalFormat("###,###,###");
        holder.giasp.setText("Giá: "+ decimalFormat.format(Double.parseDouble(sanPhamMoi.getGia()))+"đ");
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tensp= itemView.findViewById(R.id.itemdrink_ten);
            giasp=itemView.findViewById(R.id.itemdrink_gia);
            hinhanh=itemView.findViewById(R.id.itemdrink_image);
